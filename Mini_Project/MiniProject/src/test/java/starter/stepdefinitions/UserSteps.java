...
public class UserSteps {
    ...
    public void userEnterAValidFullName() {
        registerPage.userEnterAValidFullName("Iftitah lagi");
    }

    @And("user enter a valid email")
    public void userEnterAValidEmail() {
        registerPage.userEnterAValidEmail("iftitahh@gmail.com");
    }

    @And("user enter a valid password")
    public void userEnterAValidPassword() {
        registerPage.userEnterAValidPassword("1234567");
    }
